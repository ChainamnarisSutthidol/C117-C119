...
document.getElementById("to_be_drawn").innerHTML=quick_draw_data_set[random_number];
document.getElementById("to_be_drawn").innerHTML='Sketch to be drawn: '+quick_draw_data_set[random_number];
